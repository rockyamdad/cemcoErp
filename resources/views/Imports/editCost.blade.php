...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i>Edit Import Cost Information</div>
            <div class="actions">
        ...
        <div class="portlet-body form">
            ...
            <div class="tab-content">
                ...
                @if(!$importProformaInvoice->isEmpty())
                @include('Imports.partial_editProformaInvoice')
                @endif

                @if(!$importBankCost->isEmpty())
                @include('Imports.partial_editBankCost')
                @endif

                @if(!$importCnfCost->isEmpty())
                @include('Imports.partial_editCnfCost')
                @endif

                @if(!$importOtherCost->isEmpty())
                @include('Imports.partial_editOtherCost')
                @endif
