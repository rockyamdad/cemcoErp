...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        ...
        <div class="portlet-body form">
            ...
            {!!Form::model($stockInfo,array('action' => array('StockInfoController@postUpdate',$stockInfo->id), 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'stock_info_form'))!!}
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {!! Form::select('branch_id',[null=>'Please Select Branch'] +$branchAll,$stockInfo->branch_id, array('class'=>'form-control','id'=>'branch_id'))!!}
                    </div>
                </div>
