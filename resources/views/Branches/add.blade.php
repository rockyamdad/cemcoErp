...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="{{URL::to('branchAdd')}}">Add Branch</a></li>
        </ul>
...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i>Add Branch</div>
            <div class="actions">
                <a class="btn dark" href="{{ URL::to('branchList') }}">Branch List</a>
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {!!Form::open(array('url' => 'branch/saveBranch', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'branch_form'))!!}
            <div class="form-body">
