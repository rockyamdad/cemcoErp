...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="{{URL::to('productCategories/create')}}">Add Product Category</a></li>
        </ul>
...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i>Add Product Category</div>
            <div class="actions">
                <a class="btn dark" href="{{ URL::to('productCategories/index') }}">Product Category List</a>
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {!!Form::open(array('url' => '/saveProductCategory', 'method' => 'post', 'class'=>'form-horizontal',
            'id'=>'category_form'))!!}
            <div class="form-body">
