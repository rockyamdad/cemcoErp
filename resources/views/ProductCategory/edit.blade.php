...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {!!Form::model($category,array('action' => array('ProductCategoryController@postUpdateCategory',
            $category->id), 'method' => 'POST', 'class'=>'form-horizontal', 'id'=>'category_form'))!!}
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        +$branchAll,$category->branch_id,'null', array('class'=>'form-control') )!!}
                    </div>
                </div>
