...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i>Edit Expense</div>
            <div class="actions">
           ...
           $expense->id), 'method' => 'POST', 'class'=>'form-horizontal expense_form'))!!}
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {!!Form::select('branch_id',[null=>'Please Select Branch'] +$branchAll,$expense->branch_id,
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        'Rent Expense','Others '=>'Other Expense'),$expense->category, array('class'=>'form-control','id'=>'category'))!!}
                    </div>
                </div>
                <div class="form-group">
