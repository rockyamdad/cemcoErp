...
<div class="col-md-16">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i> Sales Party Ledger Report </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {!!Form::open(array('url' => 'sales-party-ledger', 'method' => 'post', 'class'=>'form-horizontal'))!!}
            <div class="form-body">
