    ...
    <div class="col-md-16">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-reorder"></i>Accounts Report Search</div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'reports/accountsresult', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'accounts_report_form'))!!}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        {!!HTML::decode(Form::label('account_id','Choose Account<span class="required">*</span>',array('class'
                        => 'control-label col-md-3')))!!}
                        <div class="col-md-4">
                            {!!Form::select('account_id',[null=>'Please Select Account'] +$accountAll,'null',
                            array('class'=>'form-control ','id'=>'account_id') )!!}
                        </div>
                    </div>
