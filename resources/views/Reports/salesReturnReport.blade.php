    ...
    <div class="col-md-16">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-reorder"></i>Sales Return Report Search</div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'sales-return-report', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'expense_payment_report_form'))!!}
                <div class="form-body">
