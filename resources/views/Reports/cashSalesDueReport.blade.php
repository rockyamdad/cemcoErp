    ...
    <div class="col-md-16">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-reorder"></i>Cash Sales Due Report Search</div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => '/cash-sale-result', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'sales_due_report_form'))!!}
                <div class="form-body">
