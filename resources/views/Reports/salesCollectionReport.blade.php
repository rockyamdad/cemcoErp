...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="page-title">
                Sales Collection Report Search
            </h3>
    ...
    <div class="col-md-16">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-reorder"></i>Sales Collection Report Search</div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'sales-collection-report', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'sales_collection_report_form'))!!}
                <div class="form-body">
