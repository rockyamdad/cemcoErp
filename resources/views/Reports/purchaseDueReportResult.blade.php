...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="page-title">
                @if ($branches)
                    Purchase Due Report For Branch : {{$branches->name}}
                @else
                    Purchase Due Report
                @endif
            </h3>
                        ...
                        @foreach($results as $result )
                           ...
                           $payment = $reports->getPaymentForPurchaseDueReport($date1,$date2,$result->party);
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="text-align: right;">{{$result->totalSale + $result->partyBalance - $payment[0]->totalPayment}}</td>
                            ...
                            $totalDue = $totalDue + ($result->totalSale + $result->partyBalance - $payment[0]->totalPayment);
                            ?>
                        @endforeach
                        <tr>
