    ...
    <div class="col-md-16">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-reorder"></i>Stock Report Search</div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'stock-report', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'Stock_report_form'))!!}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        {!!HTML::decode(Form::label('category_id','Choose Category<span class="required">*</span>',array('class' =>
                        'control-label col-md-3')))!!}
                        <div class="col-md-4">
