<script>
    function closeModal() {
        /*$('#sale').modal('hide');
         ...
         $('.modal-backdrop').hide();*/
        $("#ajax2").modal('hide').on('hidden.bs.modal', functionThatEndsUpDestroyingTheDOM);
        $('.modal-backdrop').hide();
    }
</script>
<div class="modal-dialog shape">
    <div class="modal-content">
        ...
        <div class="modal-body">
            {!!Form::model($account,array('action' => array('AccountNameController@postUpdate', $account->id), 'method' => 'POST', 'class'=>'form-horizontal account_name_form', 'id'=>'account_name_form'))!!}
                ...
                <div class="portlet-body form" id="testt">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                {!!Form::select('branch_id',[null=>'Please Select Branch'] +$branchAll,$account->branch_id,
                        ...
                        <div class="form-group">
                            ...
                            => 'control-label col-md-4')))!!}
                            <div class="col-md-7">
                                {!!Form::select('account_category_id',[null=>'Please Select Account Category']+$accountCategoriesAll,$account->account_category_id, array('class'=>'form-control') )!!}
                            </div>
                        </div>
                        <div class="form-group">
